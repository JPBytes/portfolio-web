...
export const labels = {
	es: {
		...
		// -----
		"services.title-software": "Desarrollo web",
		"services.software-service1-title": "Diseño y desarrollo de Landing Pages:",
		"services.software-service1-description":
			"Páginas de aterrizaje diseñadas y optimizadas para tus clientes.",

		"services.software-service2-title": "Creación de páginas web informativas:",
		"services.software-service2-description":
			"Sitios que presentan a tu marca,negocio, servicio o proyecto de forma clara y profesional.",

		"services.software-service3-title": "Diseño responsivo:",
		"services.software-service3-description":
			"Adaptación perfecta a cualquier dispositivo (teléfonos, tablets, computadoras).",

		"services.software-service4-title":
			"Experiencia de usuario (UX) intuitiva:",
		"services.software-service4-description":
			"Navegación sencilla y atractiva para tus visitantes .",

		// -------------------

		"services.title-design": "Diseño gráfico",
		// -----
		"services.design-service1-title": "Diseño de materiales promocionales:",
		"services.design-service1-description":
			"Posters y flyers que captan la atención de tu público.",

		"services.design-service2-title": "Desarrollo de gráficos para eventos:",
		"services.design-service2-description":
			"Desde anuncios hasta programas visuales.",

		"services.design-service3-title":
			"Creación de piezas gráficas para campañas:",
		"services.design-service3-description":
			"Adaptables para medios impresos o digitales.",

		"services.design-service4-title": "Comunicación visual clara y atractiva:",
		"services.design-service4-description": "Para que tu mensaje destaque.",
		...
		"experience.3.description":
			"Diseñé y desarrollé una aplicación web para gestión de equipos en taller, con registro de ingresos, seguimiento de reparaciones y trazabilidad de procesos, optimizando la información y mejorando la eficiencia en la toma de decisiones.",
		...
		"contactme.p2":
			"Estoy disponible para asumir nuevos proyectos freelance, colaboraciones y oportunidades laborales. Por favor, no dude en ponerse en contacto conmigo para discutir de qué manera puedo contribuir a sus objetivos profesionales.",
	...
	en: {
		...
		"services.software-service3-description":
			"Perfect adaptation to any device (phones, tablets, computers).",
		...
		"contactme.form.asunto": "Subject",
		"contactme.form.mensaje": "Message",
		"contactme.form.enviar": "Send",
	},
	nb: {
		"nav.home": "Hjem",
		"nav.about": "Om meg",
		...
		"project.graphic.4": "/IMGS/Projects/Graphic/NO/Produkter2.webp",
		"project.graphic.5": "/IMGS/Projects/Graphic/NO/TEKNOLOGI1.webp",
		...
		"contactme.form.mensaje": "Melding",
		"contactme.form.enviar": "Send",
	},
};
